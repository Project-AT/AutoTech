...
val specialStageItemStackMap as IIngredient[][string] = {
    "two" : [
        ...
        <enderio:block_simple_wired_charger>, <enderio:block_reservoir>, <enderio:block_simple_alloy_smelter>, <enderio:item_magnet>, <enderio:item_coord_selector>,
        ...
        <enderio:block_alloy:5>, <enderio:block_alloy:4>, <enderio:block_alloy:7>, <enderio:item_alloy_ingot:7>, <enderio:item_alloy_ingot:2>, <enderio:block_alloy>,
        ...
        <ore:itemVibrantPowder>, <ore:itemPulsatingCrystal>, <ore:itemRemoteAwarenessUpgrade>, <ore:dustCarobbiite>, <ore:dustBeryllium>, <enderio:item_alloy_nugget:4>,
        ...
        <ore:notPastureFusedQuartz>, <ore:notPastureEnlightenedFusedQuartz>, <ore:notPastureDarkFusedQuartz>, <contenttweaker:crude_silicon_dust>, <enderio:item_conduit_probe>,
    ...
    "three" : [
        ...
        <ore:gemEnderBiotite>, <ore:crystalCertusQuartz>, <appliedenergistics2:material:1>, <ore:dustCertusQuartz>, <appliedenergistics2:quartz_block>,  
    ...
    "four" : [
        ...
        <nuclearcraft:quantum_computer_gate_single:0>, <nuclearcraft:quantum_computer_gate_single:1>, <nuclearcraft:quantum_computer_gate_single:2>, 
        <nuclearcraft:quantum_computer_gate_single:3>, <nuclearcraft:quantum_computer_gate_single:4>, <nuclearcraft:quantum_computer_gate_single:5>, 
        <nuclearcraft:quantum_computer_gate_single:6>, <nuclearcraft:quantum_computer_gate_single:7>, <nuclearcraft:quantum_computer_gate_single:8>, 
        <nuclearcraft:quantum_computer_gate_single:9>, <nuclearcraft:quantum_computer_gate_single:10>, <nuclearcraft:quantum_computer_gate_single:11>,
        <nuclearcraft:quantum_computer_gate_control:0>, <nuclearcraft:quantum_computer_gate_control:1>, <nuclearcraft:quantum_computer_gate_control:2>, 
        <nuclearcraft:quantum_computer_gate_control:3>, <nuclearcraft:quantum_computer_gate_control:4>, <nuclearcraft:quantum_computer_gate_control:5>, 
        <nuclearcraft:quantum_computer_gate_control:6>, <nuclearcraft:quantum_computer_gate_control:7>, <nuclearcraft:quantum_computer_gate_control:8>, 
        <nuclearcraft:quantum_computer_gate_control:9>, <nuclearcraft:quantum_computer_gate_control:10>, <nuclearcraft:quantum_computer_gate_control:11>,
        ...
        <contenttweaker:damaged_psd>, <ore:dyeMachine>, <ore:itemEnhancedChassiParts>, <ore:itemEnhancedMachineChassi>, <ore:ingotHighStrengthAluminumAlloy>, 
        <ore:plateHighStrengthAluminumAlloy>, <ore:nuggetHighStrengthAluminumAlloy>, <ore:gearHighStrengthAluminumAlloy>, <ore:dustHighStrengthAluminumAlloy>, 
        <ore:rodHighStrengthAluminumAlloy>, <ore:blockHighStrengthAluminumAlloy>, <ore:plateTough>, <ore:gearTough>, <ore:blockTough>, <ore:ingotTough>,
...
val exceptItemStacks as IIngredient[] = [
    ...
    <extrautils2:largishchest>, <extrautils2:spike_diamond>, <extrautils2:spike_gold>, <extrautils2:minichest>, <extrautils2:redstoneclock>, <extrautils2:redstonelantern>,
    ...
    <ore:petalBrown>, <ore:petalBlue>, <ore:petalPurple>, <ore:petalCyan>, <ore:mysticFlowerWhiteDouble>, <ore:mysticFlowerOrangeDouble>, <extrautils2:spike_iron>, 
    ...
    <ore:mysticFlowerBrownDouble>, <ore:mysticFlowerBlueDouble>, <ore:mysticFlowerPurpleDouble>, <ore:mysticFlowerCyanDouble>, <botania:petalblock:15>, 
    ...
    <botania:petalblock:2>, <botania:petalblock:1>, <botania:petalblock:10>, <botania:petalblock:11>, <botania:petalblock:12>, <botania:petalblock:14>, <botania:petalblock:13>,
    <roots:mortar>, <roots:roots_guide>, <patchouli:guide_book>.withTag({"patchouli:book": "naturesaura:book"}), <ore:ingotRoseGold>, <ore:dustRoseGold>, <ore:nuggetRoseGold>,
    ...
    <multiblocked:steam_boiler>, <multiblocked:turbine_generator>, <modularmachinery:blockbunker>, <multiblocked:multiblock_builder>, <ore:blockRoseGold>,
    ...
    <appliedenergistics2:material:21>, <appliedenergistics2:smooth_sky_stone_block>, <appliedenergistics2:sky_stone_brick>, <appliedenergistics2:sky_stone_small_brick>,
